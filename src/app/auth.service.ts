...
export class AuthService {
  ...
  async register(email:string,password:string,displayName: string): Promise<User> {
    try{
      ...
      this.presentAlert("No se pudo completar el registro, es posible que el email no sea valido o que algun usuario ya tenga este email en uso, verifica tus datos e intentalo de nuevo. (No usar autorelleno)");
    }
  }
